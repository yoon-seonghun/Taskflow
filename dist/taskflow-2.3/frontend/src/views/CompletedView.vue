...
<template>
  <div class="h-full flex flex-col">
    ...
    <div class="flex items-center justify-between mb-4">
      <div>
        <h2 class="text-xl font-semibold text-gray-900 dark:text-white">완료 작업</h2>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 mb-4">
      <div class="flex flex-wrap items-center gap-4">
        ...
        <div class="ml-auto flex items-center gap-2">
          <span class="text-sm text-gray-600 dark:text-gray-400">완료시간순</span>
          <button
          ...
          <table class="w-full">
            <thead class="sticky top-0 bg-gray-50 dark:bg-gray-700 z-10">
              <tr class="border-b border-gray-200 dark:border-gray-600">
                ...
                <th class="px-4 h-10 text-left text-[13px] font-medium text-gray-600 dark:text-gray-300 whitespace-nowrap min-w-[300px]">
                  <div class="flex items-center gap-1.5">
                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                ...
                <td class="px-4 h-10 text-[13px] text-gray-900 dark:text-white">
                  <div class="flex items-center gap-2">
                    ...
                    <!-- Notion 스타일 '열기' 버튼 -->
                    <button
                      class="flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity px-1.5 py-0.5 text-[11px] text-gray-500 hover:text-primary-600 hover:bg-primary-50 dark:text-gray-400 dark:hover:text-primary-400 dark:hover:bg-primary-900/30 rounded"
                      title="상세 패널 열기"
