...
<template>
  <div class="groups-view">
    <!-- 헤더 -->
    <div class="mb-6">
      <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100">그룹 관리</h1>
      ...
      <div class="lg:col-span-7">
        ...
        <template v-else>
          <div class="empty-state">
            ...
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">그룹을 선택하면 멤버를 관리할 수 있습니다.</p>
          </div>
        </template>
      </div>
    </div>
