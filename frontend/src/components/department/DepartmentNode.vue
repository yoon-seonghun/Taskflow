...
.node-row.selected {
  @apply bg-primary-50 dark:bg-primary-900 hover:bg-primary-100 dark:hover:bg-primary-800;
}
...
.toggle-btn {
  @apply p-0.5 rounded hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-500 dark:text-gray-400 flex-shrink-0;
}
...
.dept-icon {
  @apply w-6 h-6 rounded flex items-center justify-center bg-primary-100 dark:bg-primary-900 text-primary-600 dark:text-primary-400 flex-shrink-0;
}
...
.user-count {
  @apply flex items-center gap-1 text-xs text-gray-400 dark:text-gray-500 ml-auto;
}
...
.more-btn {
  @apply p-1 rounded hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 opacity-0 flex-shrink-0
...
/* 컨텍스트 메뉴 */
.context-menu {
  @apply fixed z-50 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1 min-w-[160px];
}

.menu-item {
  @apply w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-700 dark:text-gray-300
...
.menu-divider {
  @apply border-t border-gray-100 dark:border-gray-700 my-1;
}
</style>
